...
def train(args, train_dataset, model: PreTrainedModel, tokenizer: PreTrainedTokenizer, prefix="") -> Tuple[int, float]:
    """ Train the model """
    train_loss = dict()
...
def main():
    ...
    if args.do_train:
        ...
        global_step, tr_loss, train_loss = train(args, train_dataset, model,
                                          tokenizer)
...
def plot(loss_dict, loss_type=None):
    if loss_type == 'train':
        epochs = list(loss_dict.keys())
        loss = [v['tr_loss'] for k, v in loss_dict.items()]
    elif loss_type == 'eval':
        epochs = list(loss_dict.keys())
        loss = [v['eval_loss'] for k, v in loss_dict.items()]
...
if __name__ == "__main__":
    ...
    plot(train_loss, loss_type='train')
    plot(eval_loss, loss_type='eval')
